...
I tried improving visibility by sacrificing the aspect ratio, but even with a 0px gap (fully gapless), the screen height only increases to about x1.1 the original. So in practice, the improvement is fairly limited.  
...
# Notes
Games where the two screens visually connect will look great with the 0px gapless preset. However, in games like Metroid Prime Pinball, where gameplay depends on the physical gap between screens, the visuals may feel unnatural.
